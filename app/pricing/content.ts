...
export const PRICING_CONTENT: Record<Locale, PricingContent> = {
  ...
  ko: {
    metaTitle: "요금",
    metaDescription:
      "gliddy는 단발 결제형 여행 플래너 — 한 플랜 $4. 구독·숨은 비용·계정 가입 없음.",
    eyebrow: "요금",
    headline: "한 플랜, $4. 끝.",
    intro:
      "구독 없음. 숨은 비용 없음. 가입도 필요 없음. 한 번 결제하면 몇 분 안에 완성된 여행 플랜이 메일로 도착합니다.",
    priceUnit: "USD · 플랜 1개 · 1회 결제",
    priceFootnote: "결제 시 현지 통화로 환산된 금액이 표시됩니다.",
    features: [
      "여행 페이스와 관심사에 맞춘 일자별 일정",
      "도착 공항에 맞춘 호텔 추천",
      "공항 → 호텔 이동 수단 (실제 비용·소요 시간 포함)",
      "번호 매겨진 코스를 핸드폰에서 바로 보는 동선 지도",
      "왜 이 식당인지 이유까지 적힌 식당 추천",
      "여행 중 오프라인 사용용 PDF 다운로드",
      "결제 후 약 60초 안에 메일 도착",
    ],
    ...
    faqs: [
      {
        q: "구독인가요?",
        a: "아니요. 플랜 1개당 $4 단발 결제예요. 다음 플랜이 필요하면 다시 $4 결제. 카드 정보는 저장하지 않고 자동 갱신도 없어요.",
      },
      {
        q: "계정이 필요한가요?",
        a: "아니요. 회원님 플랜 전용 링크를 메일로 보내드려요. 메일만 보관하시면 플랜은 계속 보실 수 있어요. 메일 잃어버리시면 저희에게 연락주세요, 다시 보내드릴게요.",
      },
      {
        q: "어떤 결제 수단이 가능한가요?",
        a: "주요 신용카드 전부 (LemonSqueezy 결제 시스템 통해), Apple Pay·Google Pay (지원 지역). 현지 통화 환산은 LemonSqueezy가 처리합니다.",
      },
      {
        q: "환불 가능한가요?",
        a: "두 경우에 가능해요: (1) 기술적 생성 실패, (2) 명백히 환각된 장소가 포함된 플랜. 자세한 내용은 아래 환불 정책 참조.",
      },
      {
        q: "왜 이렇게 저렴한가요?",
        a: "좋은 여행 일정이 $50씩 하거나 월 $15 구독에 갇혀 있을 필요 없다고 생각해요. 플랜 1건당 컴퓨팅 비용은 $4의 일부고, 나머지는 사이트 운영에 씁니다.",
      },
      {
        q: "같은 목적지로 또 만들고 싶으면요?",
        a: "결제할 때마다 입력값에서 새로 만들어요. 기간·동행 유형·관심사·예산 중 하나만 바꿔도 다른 일정이 나옵니다.",
      },
    ],
    legalPrefix: "전체 약관:",
    termsLabel: "이용약관",
