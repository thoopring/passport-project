...
export const ABOUT_CONTENT: Record<Locale, AboutContent> = {
  ...
  ko: {
    ...
    body: [
      "짧은 여행 한 번 가려고 해도 주말을 통째로 쏟게 되더라고요. 탭 서른 개 열고, 식당 스무 곳 저장하고, 아직 잡지도 않은 호텔과 동선 체크하고, 막상 도착해서는 같은 길을 두 번 왕복하고.",
      "그래서 그 일부분만 해결하는 작은 도구를 만들었어요. 몇 가지 질문에 답하면 AI가 실제 동선이 그려진 일정표를 만들어드려요. 교통편 근처 호텔, 코스 가까운 식당, 운영 시간과 아이 동반 여부까지 다 따져서요. 핸드폰에서 바로 열 수 있는 링크 + 오프라인용 PDF로 보내드려요.",
    ],
    bodyClosing:
      "한 번 결제, 한 번의 플랜. 가입도 구독도 없어요. 플랜 생성에 실패하거나 AI가 이상한 답을 내면 환불해 드려요.",
    values: [
      {
        title: "멋부리지 않고 명확하게",
        desc: "추상적인 글이 아니라 운영 시간, 주소, 짧은 도보 동선을 드려요.",
      },
      {
        title: "실재하는 장소만",
        desc: "AI는 큐레이션된 장소 DB 위에서 작동해요. 환각 식당 없음.",
      },
      {
        title: "정직한 가격",
        desc: "정가 한 가지, 추가 결제 없음. 플랜이 망가지면 환불.",
      },
    ],
    ctaButton: "여행 계획하기",
